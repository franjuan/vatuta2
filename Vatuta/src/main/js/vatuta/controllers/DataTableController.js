									...
									function($scope, $mdDialog, $mdToast, $project) {
										...
										$scope.dataTableOptions = {
										    ...
										    columnDefs: [
											    ...
											    { displayName: 'Early Start', field: 'earlyStart().format("DD-MM-YYYY")',  enableCellEdit: false, enableSorting: false, width: '*' },
											    { displayName: 'Early End', field: 'earlyEnd().format("DD-MM-YYYY")',  enableCellEdit: false, enableSorting: false, width: '*' },
											    { displayName: 'Late Start', field: 'lateStart().format("DD-MM-YYYY")',  enableCellEdit: false, enableSorting: false, width: '*' },
											    { displayName: 'Late End', field: 'lateEnd().format("DD-MM-YYYY")',  enableCellEdit: false, enableSorting: false, width: '*' },
											    { displayName: 'Actual Start', field: 'actualStart().format("DD-MM-YYYY")',  enableCellEdit: false, enableSorting: false, width: '*' },
											    { displayName: 'Actual End', field: 'actualStart().format("DD-MM-YYYY")',  enableCellEdit: false, enableSorting: false, width: '*' },
											    { displayName: 'Actual Duration', field: 'actualDuration().toString()',  enableCellEdit: false, enableSorting: false, width: '*' }
										    ],
										    data: $project.tasks(),
