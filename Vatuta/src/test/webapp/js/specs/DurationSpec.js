require([ "moment", "vatuta/services/duration", "vatuta/services/calendar"],
	...
	describe("End Start Calculations", function () {
	    ...
	    it("Midnight end in Winter", inject(function(DurationHandler, CalendarHandler){ //parameter name = service name
	    ...
	    it("Midnight end in Summer", inject(function(DurationHandler, CalendarHandler){ //parameter name = service name
	    ...
	    it("Midnight end in Holidays", inject(function(DurationHandler, CalendarHandler){ //parameter name = service name
	    ...
	    it("Midday end in Winter", inject(function(DurationHandler, CalendarHandler){ //parameter name = service name
	    ...
	    it("Midday end in Summer", inject(function(DurationHandler, CalendarHandler){ //parameter name = service name
	    ...
	    it("Midday end in Holidays", inject(function(DurationHandler, CalendarHandler){ //parameter name = service name
            var end = CalendarHandler.pastWorkingTime(Moment([2016, 7, 5, 12, 00]), calendar);
            expect(end.isSame(Moment([2016, 6, 29, 15, 0]),'minutes')).toBeTruthy();
	    }));
	    
	    it("Afternoon end in Winter", inject(function(DurationHandler, CalendarHandler){ //parameter name = service name
	    ...
	    it("Afternoon end in Summer", inject(function(DurationHandler, CalendarHandler){ //parameter name = service name
	    ...
	    it("Afternoon end in Holidays", inject(function(DurationHandler, CalendarHandler){ //parameter name = service name
